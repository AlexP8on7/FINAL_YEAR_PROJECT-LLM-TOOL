...
While no high severity vulnerabilities were found, medium severity issues can still pose significant risks if exploited.
...
#### - Content Security Policy (CSP) Header Not Set
  ...
  - **Action:** Implement a strong CSP header to restrict sources of executable scripts and other resources.

#### - Cross-Domain Misconfiguration (CORS)
  - **Risk:** May allow unauthorized cross-origin requests, leading to data leakage or abuse.
  - **Action:** Restrict CORS settings to only trusted domains and methods. Avoid using `Access-Control-Allow-Origin: *` unless absolutely necessary.

---

### **Priority 2: Low Severity Issues**
#### - Cross-Origin-Embedder-Policy & Cross-Origin-Opener-Policy Headers Missing/Invalid
  - **Risk:** Potential for cross-origin attacks and information leakage.
  - **Action:** Set these headers to appropriate values to enhance isolation between browsing contexts.

#### - Dangerous JS Functions
  - **Risk:** Use of functions like `eval`, `setTimeout`, or `setInterval` with user input can expose to XSS.
  - **Action:** Refactor code to avoid dangerous JS functions or sanitize inputs rigorously.

#### - Deprecated Feature Policy Header Set
  - **Risk:** Using outdated headers may reduce effectiveness of browser security controls.
  - **Action:** Replace `Feature-Policy` with `Permissions-Policy`.

#### - Timestamp Disclosure - Unix
  - **Risk:** May aid attackers in fingerprinting or timing attacks.
  - **Action:** Remove or mask timestamp disclosures unless required.
...
- **Set CSP Header:**  
  Add a basic CSP header (e.g., `Content-Security-Policy: default-src 'self'`) to immediately reduce XSS risk.

- **Restrict CORS:**  
  Update CORS configuration to only allow trusted origins.

- **Update Security Headers:**  
  - Add/Correct `Cross-Origin-Embedder-Policy` and `Cross-Origin-Opener-Policy` headers.
  - Replace `Feature-Policy` with `Permissions-Policy`.

- **Review JS Functions:**  
  Search for and refactor dangerous JS functions in your codebase.

- **Remove Timestamp Disclosure:**  
  Ensure server responses do not include unnecessary timestamps.

---

## Summary Table

| Severity | Issue                                   | Priority | Quick Win? |
|----------|-----------------------------------------|----------|------------|
| Medium   | CSP Header Not Set                      | 1        | Yes        |
| Medium   | CORS Misconfiguration                   | 1        | Yes        |
| Low      | Cross-Origin-Embedder/Opener Policy     | 2        | Yes        |
| Low      | Dangerous JS Functions                  | 2        | Yes        |
| Low      | Deprecated Feature Policy Header         | 2        | Yes        |
| Low      | Timestamp Disclosure                    | 2        | Yes        |

---

**Next Steps:**  
Focus on implementing CSP and correcting CORS settings as your highest priorities. Update headers and review JS usage for quick improvements. Regularly re-scan after remediation to verify fixes.
...
```json
{
  "@programName": "ZAP",
  "@version": "2.17.0",
  "@generated": "Tue, 10 Mar 2026 12:24:59",
  "created": "2026-03-10T12:24:59.599478772Z",
  "insights": [
    {
      "level": "Low",
      "reason": "Warning",
      ...
      "alerts": [
        ...
        },
        {
          ...
          "instances": [
            ...
            {
              "id": "34",
              "uri": "http://host.docker.internal:8080/chunk-24EZLZ4I.js",
              "nodeName": "http://host.docker.internal:8080/chunk-24EZLZ4I.js",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "Access-Control-Allow-Origin: *",
        ...
        },
        {
          ...
          "instances": [
            {
              "id": "93",
              "uri": "http://host.docker.internal:8080/chunk-BBQJZN7H.js",
              "nodeName": "http://host.docker.internal:8080/chunk-BBQJZN7H.js",
              "method": "GET",
              "param": "",
              "attack": "",
        ...
        },
        {
          ...
          "instances": [
            ...
            {
              "id": "45",
              "uri": "http://host.docker.internal:8080/chunk-I2PSG472.js",
              "nodeName": "http://host.docker.internal:8080/chunk-I2PSG472.js",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "Feature-Policy",
            ...
            {
              "id": "40",
              "uri": "http://host.docker.internal:8080/chunk-TWZW5B45.js",
              "nodeName": "http://host.docker.internal:8080/chunk-TWZW5B45.js",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "Feature-Policy",
