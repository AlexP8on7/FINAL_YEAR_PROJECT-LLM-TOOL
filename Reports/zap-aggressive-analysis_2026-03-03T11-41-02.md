...
However, the following medium-severity issues pose significant risk if left unaddressed:

### Medium Severity Findings
- **Content Security Policy (CSP) Header Not Set**  
  *Risk*: Increases exposure to Cross-Site Scripting (XSS) and data injection attacks.
- **Cross-Domain Misconfiguration (CORS)**  
  *Risk*: May allow unauthorized cross-origin requests, leading to data theft or manipulation.
...
- **Review and restrict CORS settings.**
  ...
  - Avoid using wildcards (`*`) in `Access-Control-Allow-Origin`.

### Priority 2: Address Low Severity Issues (in order of risk)
- **Cross-Domain JavaScript Source File Inclusion**
  - Review necessity of third-party scripts.
  - Host critical scripts locally if possible.
- **Dangerous JS Functions**
  - Refactor code to avoid use of dangerous functions (e.g., `eval`, `document.write`).
...
- **Timestamp Disclosure**
  - Remove or obfuscate timestamp information from responses.
...
- **Set CSP Header:**  
  Add a basic CSP header to all responses.
- **Restrict CORS:**  
  Update CORS configuration to only allow trusted domains.
- **Update Security Headers:**  
  Replace `Feature-Policy` with `Permissions-Policy`.
- **Remove Dangerous JS Functions:**  
  Search for and refactor/remove uses of `eval`, `document.write`, etc.
...
- **Review Third-party Scripts:**  
  Audit and minimize external JavaScript inclusions.

---

## Summary Table

| Priority | Issue                                   | Quick Win? |
|----------|-----------------------------------------|:----------:|
| 1        | CSP Header Not Set                      |     ✅     |
| 1        | CORS Misconfiguration                   |     ✅     |
| 2        | Cross-Domain JS Source File Inclusion   |     ✅     |
| 2        | Dangerous JS Functions                  |     ✅     |
| 2        | Deprecated Feature Policy Header         |     ✅     |
| 2        | Insufficient Site Isolation (Spectre)   |     ✅     |
| 2        | Timestamp Disclosure                    |     ✅     |

---

**Recommendation:**  
Focus first on implementing CSP and correcting CORS settings, as these provide the most immediate security improvement. Then, address the low-severity findings for defense-in-depth. Most issues can be quickly mitigated by updating headers and reviewing code for unsafe practices.
...
```json
{
  "@programName": "ZAP",
  "@version": "2.17.0",
  "@generated": "Tue, 10 Feb 2026 11:53:05",
  "created": "2026-02-10T11:53:05.829907023Z",
  "insights": [
    {
      "level": "Info",
      ...
      "alerts": [
        {
          ...
          "instances": [
            ...
            {
              "id": "78",
              "uri": "http://host.docker.internal:8080/ftp/eastere.gg",
              "nodeName": "http://host.docker.internal:8080/ftp/eastere.gg",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "",
            ...
            {
              "id": "85",
              "uri": "http://host.docker.internal:8080/ftp/package-lock.json.bak",
              "nodeName": "http://host.docker.internal:8080/ftp/package-lock.json.bak",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "",
        ...
        },
        {
          ...
          "instances": [
            ...
            {
              "id": "55",
              "uri": "http://host.docker.internal:8080/polyfills.js",
              "nodeName": "http://host.docker.internal:8080/polyfills.js",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "Feature-Policy",
          ...
          "otherinfo": "",
          "reference": "<p>https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/Permissions-Policy</p><p>https://scotthelme.co.uk/goodbye-feature-policy-and-hello-permissions-policy/</p>",
          "cweid": "16",
          "wascid": "15",
          "sourceid": "6"
        },
        {
          ...
          "instances": [
            ...
            {
              "id": "127",
              "uri": "http://host.docker.internal:8080/juice-shop/node_modules/express/lib/router/assets/public/favicon_js.ico",
              "nodeName": "http://host.docker.internal:8080/juice-shop/node_modules/express/lib/router/assets/public/favicon_js.ico",
              "method": "GET",
              "param": "Cross-Origin-Embedder-Policy",
              "attack": "",
              "evidence": "",
        ...
        },
        {
          ...
          "instances": [
            ...
            {
              "id": "120",
              "uri": "http://host.docker.internal:8080/juice-shop/build/routes/fileServer.js:59:18",
              "nodeName": "http://host.docker.internal:8080/juice-shop/build/routes/fileServer.js:59:18",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "<script src=\"//cdnjs.cloudflare.com/ajax/libs/cookieconsent2/3.1.0/cookieconsent.min.js\"></script>",
            ...
            {
              "id": "119",
              "uri": "http://host.docker.internal:8080/juice-shop/build/routes/runtime.js",
              "nodeName": "http://host.docker.internal:8080/juice-shop/build/routes/runtime.js",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "<script src=\"//cdnjs.cloudflare.com/ajax/libs/cookieconsent2/3.1.0/cookieconsent.min.js\"></script>",
        ...
        },
        {
          ...
          "instances": [
            ...
            {
              "id": "52",
              "uri": "http://host.docker.internal:8080/styles.css",
              "nodeName": "http://host.docker.internal:8080/styles.css",
              "method": "GET",
              "param": "",
              "attack": "",
              "evidence": "max-age=0",
